            ...
            RETURNS TABLE(training_id integer, training_name varchar(100), training_description text, training_uses int, training_rate int)
            AS $$
            BEGIN
                IF number = 0 then
            ...
            END;
            $$ LANGUAGE plpgsql;
        SELECT * FROM GetExercisesForTraining(3);
